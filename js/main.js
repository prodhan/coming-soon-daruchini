...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>কিভাবে খেলবেন?</div><p>একই রঙ এর ব্লকগুলো পরপর ৩ বা ততোধিক মিলাতে হবে</p><p>" + (settings.platform != 'mobile' ? 'ডান/বাম অ্যারো বাটন চেপে অবস্থান পরিবর্তন করা যাবে' : 'ডান/বাম পাশে স্ক্রিন প্রেস করে অবস্থান পরিবর্তন করা যাবে') + " " + (settings.platform != 'mobile' ? ' নিচের বাটনে চেপে দ্রুত অবস্থান পরিবর্তন করতে পারবেন': '') + " </p><p><span style='color:#f1c40f;'> দারুচিনি </span> <span style='color:#e74c3c'> আসছে... </span> <span style='color:#3498db'> নতুন কোন সেবা নিয়ে </span> <span style='color:#2ecc71'>আপনার</span> শহরে</p> <hr> <p id = 'afterhr'></p> ডেভেলপ করছি আমরা <a href='https://www.pigeon-soft.com' target='_blank'>পিজিয়ন সফট</a>");
	if (gameState == 1) {
		pause();
	}
